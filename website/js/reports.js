...
function report_menu_creation() {
    ...
    for (var i = 0; i < search_dates.length; i++) {
        ...
        document.getElementById("reports_menu").innerHTML += "<a onclick='on_report_click(this)' href=\"" + link + "\" class=\"list-group-item list-group-item-action bg-transparent border-primary text-primary small " + active + "\" id=\"" + id + "\">" + label + "</a>";
    }
}
...
function sensor_menu_creation() {
    ...
    document.getElementById("reports_menu").innerHTML = "";
    document.getElementById("reports_menu").innerHTML += "<a onclick='report_menu_creation()' class=\"list-group-item list-group-item-action bg-transparent border-primary small text-primary \">Back</a>";
    var active = "";
    for (var i = 0; i <sensors.length; i++){
        var link = "#";
        var id = "" + sensors[i];
        var label = "" + sensors[i];
        document.getElementById("reports_menu").innerHTML += "<a onclick='on_sensor_click(this)' href=\"" + link + "\" class=\"list-group-item list-group-item-action bg-transparent border-primary text-light primary" + active + "\" id=\"" + id + "\">" + label + "</a>";
        active = "";
    }
}
