...
def generate_report(user_id):
        ...
        for day in list_of_dates:
            ...
            for my_times in interval_times:
                ...
                for line in list_of_times:
                    ...
                    new_line_2 = datetime.timedelta(hours=new_line.hour, minutes=new_line.minute,
                                                    seconds=new_line.second)
            ...
            dict_for_inserting[sensor_code] = {"Monday": copy.deepcopy(mon_temps), "Tuesday": copy.deepcopy(tue_temps),
                                               "Wednesday": copy.deepcopy(wed_temps),
                                               "Thursday": copy.deepcopy(thu_temps),
    ...
    sql_insert_report_complete = sql_insert_report_incomplete.format(user_id, todays_date, converted_dict)
